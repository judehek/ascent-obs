...
EXPORT bool enum_adapters(
  ...
  return graphics->exports.device_enum_adapters(graphics->device,callback, param);
}
...
void* gs_get_graphics_information(bool refresh) {
	graphics_t *graphics = thread_graphics;

	if (!gs_valid("gs_get_graphics_information"))
		return NULL;

	if (graphics->exports.get_graphics_information)
		return graphics->exports.get_graphics_information(refresh);
