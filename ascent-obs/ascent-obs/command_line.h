...
public:
  ...
  using SwitchMap = std::map<std::wstring, StringType, std::less<>>;
  ...
  static void InitUsingArgvForTesting(int argc, const wchar_t* const* argv);
  ...
  StringType GetSwitchValueNative(const std::wstring& switch_string) const;
