#ifndef ASCENTOBS_OBS_CONTROL_OBS_AUDIO_SOURCE_CONTROL_H_
#define ASCENTOBS_OBS_CONTROL_OBS_AUDIO_SOURCE_CONTROL_H_
...
#endif // ASCENTOBS_OBS_CONTROL_OBS_AUDIO_SOURCE_CONTROL_H_